...
class RasterWriter:
    ...
    def write(self, dataArray, rasterProperties, bandProperties):
        ...
        #self.rasterProperties = rasterProperties
        ...
        """
        print("The input band properties: \n",
        "Bit depth: ", bandProperties.getBitDepth(),"\n",
        "Interpretation: ", bandProperties.getInterpretation(), "\n",
        "Name: ", bandProperties.getName(),"\n",
        "Cols: ", bandProperties.getNumTileCols(),"\n",
        "Rows: ", bandProperties.getNumTileRows(),"\n",
        "Tile type: ", bandProperties.getTileType(), "\n")
        ...
        print("The output band properties: \n",
        "Bit depth: ", bandProperties.getBitDepth(),"\n",
        "Interpretation: ", bandProperties.getInterpretation(), "\n",
        "Name: ", bandProperties.getName(),"\n",
        "Cols: ", bandProperties.getNumTileCols(),"\n",
