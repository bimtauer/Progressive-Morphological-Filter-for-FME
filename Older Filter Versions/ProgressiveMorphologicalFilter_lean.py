...
raster2 = np.loadtxt("../Data/Merged/DEM_0.5_min_filtered_merged - kopia.asc")
# Parameters
parameters = {'c' : 0.5,                     # The cell size of the input raster
              ...
              'dhmax' : 1.5,                 # The slope threshold at maximum slope
...
MyFilter = ProgressiveMorphologicalFilter(raster2, parameters)
